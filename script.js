...
// Install a small on-page error overlay so runtime errors are visible
// even if the browser console isn't open. This helps debugging for users.
...
function addProcess(e) {
    ...
    let priority = parseInt(priorityInput.value, 10);
    if (!Number.isFinite(priority) || Number.isNaN(priority)) priority = 1;
